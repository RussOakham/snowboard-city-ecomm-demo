...
const SkiLodge = () => {
	return (
		<Shell className="h-[350px] max-w-6xl md:h-[500px] lg:h-[750px]">
			<Image
				src="/images/snowboard-landscape.jpg"
				alt="Snowboarder getting big air in front of a mountain skyline"
				className="absolute inset-0 z-0 aspect-video h-[350px] w-full object-cover md:h-[500px] lg:h-[750px]"
				width={1440}
				height={810}
				priority
			/>
			<section className="relative mx-auto flex h-full w-full max-w-5xl flex-col items-center justify-center gap-4 text-center">
				<h1 className="font-heading z-10 text-balance text-3xl text-border text-slate-200 sm:text-5xl md:text-6xl lg:text-7xl">
